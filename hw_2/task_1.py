...
FOLDER_IN = "/home/sant/tests"
FOLDER_OUT = "/home/sant/out"
FOLDER_EXTRACT = "/home/sant/folder_test"
...
def test_step2():
    ...
    res2 = checkout(f"ls {FOLDER_EXTRACT}", "test_2")
    res3 = checkout(f"ls {FOLDER_EXTRACT}/test_2", "test.txt")
